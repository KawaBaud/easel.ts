...
Deno.test("Matrix4: determinant", () => {
	const matrices = [
		...
		new Matrix4().makeRotationX(MathUtils.THIRD_PI),
	...
	const threeMatrices = [
		...
		new ThreeMatrix4().makeRotationX(MathUtils.THIRD_PI),
...
Deno.test("Matrix4: extractRotation", () => {
	const m = new Matrix4().makeRotationX(MathUtils.THIRD_PI);
	const rotation = new Matrix4();
	rotation.extractRotation(m);

	const threeM = new ThreeMatrix4().makeRotationX(MathUtils.THIRD_PI);
